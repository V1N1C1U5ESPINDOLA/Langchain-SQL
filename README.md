...
Este projeto implementa uma aplicação que permite aos usuários realizar consultas SQL em uma tabela de cursos utilizando a biblioteca Langchain para gerar as consultas a partir de perguntas em linguagem natural. A aplicação também utiliza Gradio para fornecer uma interface web interativa.
